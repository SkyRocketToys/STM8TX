...
#define USART2_BASE 0x5240
#define USART_REG(n, r) *(unsigned char*)(USART1_BASE+((n-1)*0x10)+r)

#define USART1_SR USART_REG(1, 0x00)
#define USART1_DR USART_REG(1, 0x01)
#define USART1_BRR1 USART_REG(1, 0x02)
#define USART1_BRR2 USART_REG(1, 0x03)
#define USART1_CR1 USART_REG(1, 0x04)
#define USART1_CR2 USART_REG(1, 0x05)
#define USART1_CR3 USART_REG(1, 0x06)
#define USART1_CR4 USART_REG(1, 0x07)
#define USART1_CR5 USART_REG(1, 0x08)
#define USART1_GTR USART_REG(1, 0x09)
#define USART1_PSCR USART_REG(1, 0x0A)

#define USART2_SR USART_REG(2, 0x00)
#define USART2_DR USART_REG(2, 0x01)
#define USART2_BRR1 USART_REG(2, 0x02)
#define USART2_BRR2 USART_REG(2, 0x03)
#define USART2_CR1 USART_REG(2, 0x04)
#define USART2_CR2 USART_REG(2, 0x05)
#define USART2_CR3 USART_REG(2, 0x06)
#define USART2_CR4 USART_REG(2, 0x07)
#define USART2_CR5 USART_REG(2, 0x08)
#define USART2_GTR USART_REG(2, 0x09)
#define USART2_PSCR USART_REG(2, 0x0A)
